...
func (c *greeterClient) Greet(ctx context.Context, in *GreetReq, opts ...grpc.CallOption) (*GreetRes, error) {
...
func (UnimplementedGreeterServer) Greet(context.Context, *GreetReq) (*GreetRes, error) {
...
func _Greeter_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Greet(ctx, req.(*GreetReq))
	}
